...
(function (factory) {
  ...
  var Jarallax = (function () {
    ...
    function Jarallax(item, userOptions) {
      ...
      _this.options.speed = Math.min(
        1,
        Math.max(0, parseFloat(_this.options.speed))
      );
  ...
  Jarallax.prototype.clipContainer = function () {
    ...
    if (!$styles.length) {
      $("head").append(
        '<style type="text/css" id="jarallax-clip-' +
          _this.instanceID +
          '"></style>'
      );
  ...
  Jarallax.prototype.coverImage = function () {
    ...
    // for div with background image
      ...
      css.backgroundSize =
        _this.round(resultWidth) + "px " + _this.round(resultHeight) + "px";
    }
  ...
  Jarallax.prototype.onScroll = function () {
    ...
    if (
      ...
      sectionTop > scrollTop + wndHeight
    ) {
      return;
    }
  ...
  $.fn.jarallax = function () {
    ...
    for (k; k < len; k++) {
      ...
      else ret = items[k].jarallax[options].apply(items[k].jarallax, args);
